              ...
              <tbody>
                 ...
                 while($row=mysqli_fetch_array($res))
                 {
                  ?>
                   <tr>
                  <td>
                    <center><?php echo $row["fname"];?>
                    </center></td>
                  <td>
                    <center><?php echo $row["lname"];?>
                    </center></td>
                  <td><center>
                    <?php echo $row["username"];?>
                  </center></td>
                  <td>
                    <center><?php echo $row["rrole"];?>
                    </center></td>
                  <td>
                    <center><?php echo $row["sstatus"];?>
                    </center></td>
                  <td>
                    <center><a href="edit_user.php?id=<?php echo $row["id"];?>" style="color:green;">Edit</a>
                    </center></td>
                  <td>
                  <center><a href="delete_user.php?id=<?php echo $row["id"];?>" style="color: red;">Delete</a>
                  </center></td>
                </tr>
                  <?php
                 }
...
if(isset($_POST['submit1']))
{
  ...
  if($count>0){
    ...
    $sql = "INSERT INTO user_registration
     (fname, lname,username,sstatus,ppassword,rrole)
    VALUES ('$fname', '$lname','$username','active','$password','$role')";
